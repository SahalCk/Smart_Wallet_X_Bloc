...
class _AddCardScreenState extends State<AddCardScreen> {
  ...
  final cardissuedatecontroller = TextEditingController();
  final banknamecontroller = TextEditingController();
  final cardexpdatecontroller = TextEditingController();

  String cardtype = 'Credit Card';
  Color cardcolor = const Color.fromARGB(255, 27, 27, 27);
  Color cardtextcolor = const Color.fromARGB(255, 192, 192, 192);
  String paymentnetwork = 'Visa';
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            appbarwithouttrail(
                'assets/back_arrow.png', 'Add New Card', context),
            SizedBox(
                    ...
                    children: [
                      ...
                      Neumorphic(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              padding:
                                  EdgeInsets.all(mediaquery.size.width * 0.025),
                              child: Column(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child:
                                            Image.asset('assets/card_chip.png'),
                                      ),
                                    ),
                                  ),
                                  SizedBox(
  ...
  Widget bankselecter() {
    String bank = banknamecontroller.text.toLowerCase();
  ...
  submitcard() async {
    ...
    await CardFunctions.addcard(newcard);
    succcess();
  ...
  String find() {
    if (paymentnetwork.toLowerCase().contains('visa')) {
      return 'visa';
    } else if (paymentnetwork.toLowerCase().contains('master')) {
      return 'master_card';
    } else if (paymentnetwork.toLowerCase().contains('rupay')) {
      return 'rupay';
    } else {
